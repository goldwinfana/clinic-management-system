...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE patient SET patientname='$_POST[patientname]',admissiondate='$_POST[admissiondate]',admissiontime='$_POST[admissiontime]',address='$_POST[address]',mobileno='$_POST[mobilenumber]',id_number='$_POST[id_number]',pincode='$_POST[pincode]',email='$_POST[email]',bloodgroup='$_POST[select2]',gender='$_POST[gender]',dob='$_POST[dateofbirth]' WHERE patientid='$_GET[editid]'";
...
<?php
    ...
    else
    {
        ...
        $sql ="INSERT INTO patient(patientname,admissiondate,admissiontime,address,mobileno,id_number,pincode,email,password,bloodgroup,gender,dob,status) values('$_POST[patientname]','$_POST[admissiondate]','$_POST[admissiontime]','$_POST[address]','$_POST[mobilenumber]','$_POST[id_number]','$_POST[pincode]','$_POST[email]','$pass','$_POST[select2]','$_POST[gender]','$_POST[dateofbirth]','Active')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
