...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE patient SET prescription='$_POST[prescription]' WHERE patientid='$_GET[editid]'";
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
             <textarea class="form-control" rows="12" type="text" name="prescription" id="prescription"
